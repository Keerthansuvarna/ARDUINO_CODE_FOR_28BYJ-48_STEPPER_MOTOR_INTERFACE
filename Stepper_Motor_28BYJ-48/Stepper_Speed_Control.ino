...
/*******************************## 28BYJ-48 Stepper Motor 5V DC ##************************************************
  ...
  ################################ Calculation for Rotation Per Minute (RPM) ################################################
    For 10 sec delay ---> ~ 03.0 RPM (3rpm)
    For 02 sec delay ---> ~ 14.5 RPM (14rpm)
...
int rpm_speed = 3; // Change the value as you required (3 - 14 rpm)
int set_rpm_delay = 0; //Do not change this value
...
void setup()
{
  ...
  set_rpm_delay = map(rpm_speed, 3, 14, 10, 2 );
}
