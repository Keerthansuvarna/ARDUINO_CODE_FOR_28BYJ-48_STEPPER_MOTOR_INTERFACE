...
float start_speed = 14;    // RPM           --->   Minimum = 1 & Maximum = 14 (Do not exceed theese value...will cause damage to the Stepper Motor)
float deaccelarate = 0.1; // Change in RPM --->   Change this value in which step the deaccelaration has to decrease (Recommended less than 1)
...
void setup()
{
  ...
  if (deaccelarate >= 1 || deaccelarate <= 0)

  {
    deaccelarate = 0.1; // Setting accelaration to 1
  }
